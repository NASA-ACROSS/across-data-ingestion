...
INSTRUMENT_URL: str = f"{config.across_server_url()}/instrument/"


def get(params: dict = {}) -> list[dict]:
    """
    Method to utilize the ACROSS web api to access many instruments
    ...
    query_url = f"{INSTRUMENT_URL}?{query_string}"
