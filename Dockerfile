...
COPY across_data_ingestion/__about__.py ./across_data_ingestion/
...
CMD [ "fastapi", "dev", "across_data_ingestion/main.py", "--host", "0.0.0.0", "--port", "8000"]
...
# Copy source code
COPY ./across_data_ingestion ./across_data_ingestion
